...
public class PostController {
    ...
    public String sortBy(@RequestParam("sortOrder") String keywordToBeSorted, Model model, RedirectAttributes redirectAttributes)
    {
//		blogService.sortBy(keywordToBeSorted);
//		if (blogService.blogPostsToShow.size()==0)
//		{
//			return "noresultsfound.html";
//		}
//		blogService.getBlogPage(0,5);
//		redirectAttributes.addAttribute("sortOrder",keywordToBeSorted);
    ...
    public String filterTags(@RequestParam("tag") String tag,@RequestParam(value="from",defaultValue="2021-12-25") Date from,
                             @RequestParam(value="to",defaultValue="2022-12-25") Date to,@RequestParam("keywordToSearch") String keywordToSearch,
                             @RequestParam(value = "sortOrder",defaultValue = "UpdatedAt") String keywordToBeSorted,
                             @RequestParam(value="author",defaultValue = "asim") String author,RedirectAttributes redirectAttributes)
    {
        System.out.println("");
        System.out.println(author+"      jnkm,kml");
        System.out.println("");
